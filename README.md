# nvim-treesitter-queries-pem

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pem/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pem/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pem**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pem",
...
- [ ] Changes are scoped to `pem` — do not include files for other languages
